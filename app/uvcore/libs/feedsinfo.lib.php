...
$uv_testfeeds = (isset($_REQUEST["debug"])) ? $_REQUEST["debug"] : false;
...
$uvlib_feeds = array(
	...
	"photogallery" => array(
		"url" => "http://{uvserver}/apis/galbums.json?{params}",
		"expiration" => 3600,
		"varpass" => "get"
	),
	"photoalbum" => array(
...
$uvlib_mediafeeds = array(
	...
	"m2604" => array(
		"type" => "imagegallery",
		"feedreturn" => "feed",
		"feedreturnpath" => "imagegallery:0:images"
	),
	"m2601" => array(
		"type" => "videogallery",
		"feedreturn" => "feed",
		"feedreturnpath" => "gallery:0:videos:0:video"
	)
);
