...
$uv_proxyurl = isset($uv_proxyurl) ? $uv_proxyurl : $uv_corepath . "/uvcore.proxy.php";
...
$uvlib_global["sendformurl"] = isset($uv_opts["sendformurl"]) ? $uv_opts["sendformurl"] : $uv_proxyurl . "?action=uvpx_sendresform";;
...
$uvc_lib["loadcalurl"] = isset($uv_opts["uvc-loadcalurl"]) ? $uv_opts["uvc-loadcalurl"] : $uv_proxyurl . "?action=uvpx_loadcal";
...
$uvg_lib["loadalbumurl"] = isset($uv_opts["uvg-loadalbumurl"]) ? $uv_opts["uvg-loadalbumurl"] : $uv_proxyurl . "?action=uvpx_loadalbumpop";
$uvg_lib["albumpoptemplate"] = isset($uv_opts["uvg-albumpoptemplate"]) ? $uv_opts["uvg-albumpoptemplate"] : "default";

$uvv_lib = array();
$uvv_lib["loadvideopopurl"] = $uv_proxyurl . "?action=uvpx_loadvideopop";
