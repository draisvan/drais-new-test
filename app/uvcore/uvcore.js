...
jQuery(document).on("click", ".uvjs-setvideo", function(e){
	e.preventDefault();
	...
	jQuery(".uv-pa-picvisor .uv-pa-picharge").html("<iframe src='https://www.youtube.com/embed/" + uvvideoid + "?autoplay=1'></iframe>");
});
...
jQuery(document).on("click", ".uvjs-pa-nextvid", function(e){
	uvPvNext();
});
jQuery(document).on("click", ".uvjs-pa-prevvid", function(e){
	uvPvPrev();
});
...
function uvPvNext(){
	...
	uvnextpicob.addClass("active");
	var uvvideoid = uvnextpicob.data("videoid");
	jQuery(".uv-pa-picvisor .uv-pa-picharge").html("<iframe src='https://www.youtube.com/embed/" + uvvideoid + "?autoplay=1'></iframe>");
}
function uvPvPrev(){
	var uvcurpicob = jQuery(".uv-pa-list .active");
